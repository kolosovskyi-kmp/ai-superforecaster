...
if __name__ == "__main__":
    ...
    # Safe default: generating reports must not publish forecasts unless the
    # operator explicitly opts in via an environment variable.
    publish_to_metaculus = (
        os.getenv("PUBLISH_TO_METACULUS", "false").lower() == "true"
    )
